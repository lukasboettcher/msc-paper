...
Andersen's analysis is an inclusion based inter-procedural pointer analysis algorithm first proposed by \cite{andersen1994program}. It is a field-sensitive, context-insensitive and flow-insensitive analysis. 
