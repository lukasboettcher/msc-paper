...
\subsection{Andersen Analysis via CFL-Reachability}
...
$$R=\{P\rightarrow \bar{a}, P\rightarrow cP, P\rightarrow lPP, P\rightarrow \bar{P}sP\}$$
$$CFG_{ander}=(\{P\}, \{a,c,l,s,\bar{a},\bar{c},\bar{l},\bar{s}\}, R, P)$$
...
Next we will consider an example to illustrate the
