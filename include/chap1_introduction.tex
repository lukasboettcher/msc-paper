...
Especially when working with older non-strictly standardized versions of the C language utilizing all available tricks of an established compiler proves to be more resourceful compared to reinventing the wheel with new tools.
