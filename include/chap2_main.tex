...
\begin{center}
    \begin{tikzpicture}[squarednode/.style={rectangle, draw=red!60, fill=red!5, very thick, minimum size=5mm}]
        ...
        % \foreach \r in {0,...,31} \node at (\r*\step+0.5*\step,0.5*\step) {\small1};
        \node[draw,align=left,font = {\tiny}] at (40*\step,0.5*\step) {Element in a sparse bitvector};
        ...
        \node[draw,align=left,font = {\tiny}] at (40*\step,-3.5*\step) {UINT bit representation of\\2nd index in element};
