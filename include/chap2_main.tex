...
\begin{table}
    \centering
    \caption{Benchmark results comparing PTAGPU, Andersen Wavediff and naive Andersen analysis measured in seconds.}
    \label{tab:benchmarkresults}
    \begin{tabular}{||c S[table-format = 5.3] S[table-format = 4.3] S S[table-format = 2.2,retain-zero-exponent=true]||}
        \hline
